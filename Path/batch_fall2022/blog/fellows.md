# Academy Fall :fallen_leaf: 2022 Batch Wiki
...
### Frontend path <br>
The first path is formed by [fellow's name](githublink), [fellow's name](https://github.com/xx) and [fellow's name](https://github.com/xx). <Smmall motto>. <br>
